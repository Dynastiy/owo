<template>
  <div class="card-carousel">
    <transition name="fade">
      <div v-if="currentImage" :key="currentImage.src">
        <div class="card-img" :style="generateURL"></div>
      </div>
    </transition>
...
export default {
  ...
  computed: {
    ...
    generateURL() {
      ...
      // }, 1000)
      return this.currentImage ? { backgroundImage: `url(${this.currentImage.src})` } : {}
    }
  },
